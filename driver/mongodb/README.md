...
For a detailed example see: [sample_mongodb_migrator.go](https://github.com/axiomzen/migrate-1/blob/master/driver/mongodb/example/sample_mongdb_migrator.go)

```go
package my_mongo_db_migrator

import (
  "github.com/axiomzen/migrate-1/driver/mongodb"
  "github.com/axiomzen/migrate-1/driver/mongodb/gomethods"
  "gopkg.in/mgo.v2"
)
